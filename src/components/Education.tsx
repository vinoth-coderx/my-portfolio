...
const Education: React.FC<EducationProps> = ({ isLowPerformance = false }) => {
  ...
  return (
    <section id="education" className="py-16 md:py-24 relative overflow-hidden bg-black">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="space-y-8 md:space-y-12">
            {portfolioData.education.map((edu, index) => (
              <motion.div
                ...
                } flex-col gap-4 md:gap-8 items-start`}
              >
                {/* Timeline dot */}
                ...
                <div className="md:w-1/2 w-full">
                  <div className="bg-gray-900 border border-emerald-900/30 rounded-xl md:rounded-2xl p-6 md:p-8 hover:border-emerald-800/50 transition-all duration-300">
        ...
        {/* Certification */}
        <motion.div {...fadeIn} className="mt-12 md:mt-16 max-w-2xl mx-auto">
          <div className="bg-gradient-to-r from-emerald-600/20 to-green-600/20 border border-emerald-500/30 rounded-xl md:rounded-2xl p-6 md:p-8 text-center">
